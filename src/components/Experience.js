  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        "Built back-end systems for an Asian banking platform, enabling secure multi-country transactions",
        ...
        "Boosted payment success rates by 15% across 500k+ daily transactions by refining back-end microservices and resolving critical bugs in K8s",
      ],
    },
    {
      ...
      responsibilities: [
        "Built Angular and Node.js applications, reducing API response time by ~30% for 10K+ users",
        "Introduced face recognition and geofencing, improving attendance accuracy significantly",
        "Architected secure back-end systems with Redis authentication, rate limiting, and webhook integration",
        "Accelerated database performance by 20%+ through indexing and query tuning",
        "Integrated REST and SOAP APIs for third-party services and payment systems",
      ],
    },
    {
